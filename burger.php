<?php
  ...
  include ("admin/basededatos/databases.php");
    ...
    if(isset($_GET['id'])){
     ...
     $query =$bd->prepare("SELECT imagen FROM burger WHERE id = '${id}'");
...
$query = $bd ->prepare ("SELECT * FROM burger");
...
<!DOCTYPE html>
	...
	<body>
           ...
           <?php  foreach($listaPortafolio as $portafolio):?>
            <div class="productos">
            <img src="images/burger/<?php echo $portafolio['imagen']; ?>.jpg" class="imagen-tabla"> 
