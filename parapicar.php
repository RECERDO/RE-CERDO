<?php
  ...
  include ("admin/basededatos/databases.php");
    ...
    if(isset($_GET['id'])){
     ...
     $query =$bd->prepare("SELECT imagen FROM picar WHERE id = '${id}'");
...
$query = $bd ->prepare ("SELECT * FROM picar");
...
<!DOCTYPE html>
	...
	<body>
           ...
           <?php  foreach($listaPortafolio as $portafolio):?>
            <div class="productos">
            <img src="images/picar/<?php echo $portafolio['imagen']; ?>.jpg" class="imagen-tabla"> 
