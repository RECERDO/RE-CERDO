<?php
  ...
  include ("admin/basededatos/databases.php");
    ...
    if(isset($_GET['id'])){
     ...
     $query =$bd->prepare("SELECT imagen FROM sandwich WHERE id = '${id}'");
...
$query = $bd ->prepare ("SELECT * FROM sandwich");
...
<!DOCTYPE html>
	...
	<body>
           ...
           <?php  foreach($listaPortafolio as $portafolio):?>
            <div class="productos">
            <img src="images/sandwich/<?php echo $portafolio['imagen']; ?>.jpg" class="imagen-tabla"> 
