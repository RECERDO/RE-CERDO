<?php
  ...
  include ("admin/basededatos/databases.php");
    ...
    if(isset($_GET['id'])){
     ...
     $query =$bd->prepare("SELECT imagen FROM bebidas WHERE id = '${id}'");
...
$query = $bd ->prepare ("SELECT * FROM bebidas");
...
<!DOCTYPE html>
	...
	<body>
           ...
           <?php  foreach($listaPortafolio as $portafolio):?>
            <div class="productos">
            <img src="images/bebidas/<?php echo $portafolio['imagen']; ?>.jpg" class="imagen-tabla"> 
